	...
	<div class="container">
		...
		<form action="memberLogin" method="POST">
			<table>
				...
				<tr>
					<td colspan="2"><input type="submit" value="로그인" class="btn btn-primary">
					<a onclick= "location.href='JoinForm.jsp'" class="btn btn-primary">회원가입</a></td>
				</tr>
